...
python do_validate_package_versions() {
    ...
    installed_packages_versions_file = d.getVar("INSTALLED_PACKAGES_VERSIONS_FILE", d, True)
    do_not_validate_package_version_for = d.getVar("DO_NOT_VALIDATE_PACKAGE_VERSION_FOR", d, True).split()
